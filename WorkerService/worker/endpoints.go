...
func (route *Worker) SendJson(w http.ResponseWriter, r *http.Request, id string) {
...
func (route *Worker) GreenList(w http.ResponseWriter, r *http.Request) {
	route.SendJson(w, r, "#green-list-of-countries-and-territories---from-17-may")
}

func (route *Worker) AmberList(w http.ResponseWriter, r *http.Request) {
	route.SendJson(w, r, "#amber-list-of-countries-and-territories")
}

func (route *Worker) RedList(w http.ResponseWriter, r *http.Request) {
	route.SendJson(w, r, "#red-list-of-countries-and-territories")
}
